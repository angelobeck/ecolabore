...
class eclStore_financialTax
{ // class eclStore_financialTax

public $name = 'financial_tax';

public $fields = [
// Indexing
'domain_id' => 'mediumint', 
'from_contract_id' => 'mediumint', 
'to_contract_id' => 'mediumint', 
'id' => 'primary_key', 
// Class identifiers
'status' => 'tinyint', 
...
// Index
public $index = [
'financial_tax_find_from' => ['domain_id', 'from_contract_id'],
'financial_tax_find_to' => ['domain_id', 'to_contract_id'],
];
