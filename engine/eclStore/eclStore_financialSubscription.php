...
class eclStore_financialSubscription
{ // class eclStore_financialSubscription

public $name = 'financial_subscription';
...
'incoming_id' => 'mediumint', 
'outgoing_id' => 'mediumint', 
// Dates
'created' => 'time', 
'updated' => 'time', 
// Contents
...
// Index
public $index = [
'financial_subscription_find_domain' => ['domain_id'],
'financial_subscription_find_user' => ['user_id'], 
];
