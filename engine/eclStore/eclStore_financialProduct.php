...
class eclStore_financialProduct
{ // class eclStore_financialProduct

public $name = 'financial_product';

public $fields = [
// Indexing
'domain_id' => 'mediumint', 
'parent_id' => 'mediumint', 
'buy_contract_id' => 'mediumint', 
'cart_id' => 'mediumint', 
'id' => 'primary_key', 
// Class identifiers
'status' => 'tinyint', 
...
// values
'buy_units' => 'mediumint', 
'sell_units' => 'mediumint', 
'buy_value' => 'mediumint', 
'sell_value' => 'mediumint', 
];

// Index
public $index = [
'financial_product_find_domain' => ['domain_id', 'status', 'parent_id'],
'financial_product_find_cart' => ['domain_id', 'cart_id'],
];
