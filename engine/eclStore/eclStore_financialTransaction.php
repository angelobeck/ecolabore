...
class eclStore_financialTransaction
{ // class eclStore_financialTransaction

public $name = 'financial_transaction';
...
// Index
public $index = [
'financial_transaction_find_contract' => ['domain_id', 'contract_id'],
'financial_transaction_find_account' => ['domain_id', 'account_id'],
'financial_transaction_find_user' => ['user_id', 'user_account_id'],
];
